...
parser.add_argument('image_path', help='Path to the temple image')  # Changed to positional argument
parser.add_argument('--original_filename', help='Original filename of the uploaded image')
parser.add_argument('--model_dir', default='trained_model', help='Directory containing the model files')
parser.add_argument('--use_predefined', action='store_true', default=True, help='Use predefined captions when available')
...
def main():
    try:
        ...
        if results:
            # Output JSON for the API to parse
